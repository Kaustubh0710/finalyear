...
<head>
    <meta charset="UTF-8">
    <title><?php echo htmlspecialchars($pet['pet_name']); ?> - Cat Profile</title>
    <style>
        body {
...
<div class="profile-card" style="display: flex; gap: 2rem; align-items: flex-start; flex-wrap: wrap;">
    ...
    <div style="flex: 1 1 250px; max-width: 250px;">
        <img src="uploads/<?php echo htmlspecialchars($pet['pet_image']); ?>" alt="Cat Image" style="width:100%; border-radius:12px; box-shadow:0 4px 10px rgba(0,0,0,0.1);">
    </div>

    <!-- Pet and Owner Info -->
    <div style="flex: 2 1 400px;">
        <h2 style="text-align: center; color: #e17055;"><?php echo htmlspecialchars($pet['pet_name']); ?>'s Cat Profile</h2>
        ...
        <div style="text-align:center;">
            <a href="catmating.php" style="padding:10px 20px;background:#e17055;color:white;text-decoration:none;border-radius:8px;">← Back to List</a>
        </div>
    </div>
</div>
